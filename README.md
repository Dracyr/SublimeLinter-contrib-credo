...
This linter plugin for [SublimeLinter][docs] provides an interface to [credo](https://github.com/rrrene/credo). It will be used with files that have the “__Elixir__” syntax.
...
**Note:** This plugin requires `credo` __0.5.3__ or later.
